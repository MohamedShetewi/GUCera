...
<head runat="server">
    <title>Non Accepted Courses</title>
...
<form id="HtmlForm" runat="server">
    <h1 style="color: white" class="m-5 d-flex justify-content-center">Non Accepted Courses</h1>
    <div class="d-flex mt-5 justify-content-center">
        <asp:Table runat="server" ID="nonAcceptedCourses" CssClass="table table-bordered table-striped table-hover courses">
        </asp:Table>
    </div>
</form>
</body>

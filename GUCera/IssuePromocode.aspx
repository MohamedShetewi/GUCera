<%@ Page Language="C#" CodeBehind="IssuePromocode.aspx.cs" Inherits="GUCera.IssuePromocode" %>
...
<form id="HtmlForm" runat="server">
    <div>
        <h1 style="color: white" class="m-5 d-flex justify-content-center">Enter Promocode and Student Details</h1>
        <div class="d-flex justify-content-center">
            <div class="container details p-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <asp:TextBox runat="server" ID="studentId" CssClass="form-control" TextMode="Number" placeholder="eg. 32" required></asp:TextBox>
                    </div>
                </div>
                <div class="row justify-content-center mt-4">
                    <asp:Button runat="server" Text="Create" ID="issueBtn" CssClass="btn btn-primary" OnClick="issueBtn_OnClick" style="max-width: fit-content;"/>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-center mt-4" runat="server" id="message">
            <div class="alert alert-success" role="alert">
                Promocode Issued Successfully!
            </div>
        </div>

...
<form id="form1" runat="server">
    <h1 style="color: white" class="m-5 d-flex justify-content-center">View Assignment Grade</h1>
    <div class="d-flex justify-content-center">
        <div class="container details p-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <asp:DropDownList ID="assignmenttype" runat="server" CssClass="form-select" required>
    ...
    <div class="d-flex justify-content-center">
        <asp:Label ID="grade" runat="server" Text="0" CssClass="badge bg-light text-dark mt-3" Font-size="20px"></asp:Label>
    </div>

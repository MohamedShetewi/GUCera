    ...
    <div class="d-flex justify-content-center">
        <div class="container details p-4 mt-3">
            <div class="row mb-3">
                ...
                <div class="col">
                    <asp:TextBox ID="courseID" CssClass="form-control" TextMode="Number" runat="server" required></asp:TextBox>
                </div>
            </div>
            <div class="row justify-content-center">
                <asp:Button ID="viewButton" runat="server" CssClass="btn btn-primary" Text="View Feedbacks" OnClick="viewButton_Click" style="max-width: fit-content;"/>
            </div>
        </div>
    </div>
    <h1 style="color: white" class="d-flex justify-content-center mt-4" runat="server" ID="tableTitle">Feedbacks</h1>
    <div class="d-flex justify-content-center text-center mt-3">
        <asp:Table ID="table" runat="server" CssClass="table table-bordered table-striped table-hover feedback">

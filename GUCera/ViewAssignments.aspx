    ...
    <div class="d-flex justify-content-center">
        <div class="container details p-4 mt-3">
            ...
            <div class="row justify-content-center">
                <asp:Button ID="viewButton" runat="server" Text="View Assignments" CssClass="btn btn-primary" style="max-width: fit-content;" OnClick="viewButton_Click"/>
            </div>
        </div>
    </div>
    <h1 style="color: white" class="d-flex justify-content-center mt-4" runat="server" ID="tableTitle">Assignments</h1>
